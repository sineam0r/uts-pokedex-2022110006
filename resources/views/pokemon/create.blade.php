            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        placeholder="Species" name="species" value="{{old('species')}}">
                        @error('species')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        placeholder="Weight" name="weight" value="{{old('weight')}}">
                        @error('weight')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        placeholder="Attack" name="attack" value="{{old('attack')}}">
                        @error('attack')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        placeholder="HP" name="hp" value="{{old('hp')}}">
                        @error('hp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        placeholder="Defense" name="defense" value="{{old('defense')}}">
                        @error('defense')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
